Scriptname LATH_ROS_ImperialRace extends activemagiceffect  
...
Float RaceFlatMagicka = 10.0        ;+10 Magicka
...
Event OnEffectStart(Actor akTarget, Actor akCaster)
    ...
    ;Game.AddPerkPoints(PerkPointToGrant)
    ;------------------------------
    ; STAMINA
    ;------------------------------
