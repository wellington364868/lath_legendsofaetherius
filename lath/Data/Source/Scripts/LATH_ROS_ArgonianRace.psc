Scriptname LATH_ROS_ArgonianRace extends activemagiceffect  
...
Event OnEffectStart(Actor akTarget, Actor akCaster)
    ...
    appliedDiseaseResist = RaceDiseaseResist
