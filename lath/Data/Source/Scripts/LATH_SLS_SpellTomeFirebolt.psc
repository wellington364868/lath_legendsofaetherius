Scriptname LATH_SLS_SpellTomeFirebolt extends ObjectReference  
...
Event OnRead()
    ...
    if current_spell_tier <= max_spell_tier
        ...
        Debug.Notification("Você já sabe tudo o que é possivel saber sobre " + spell_name)
        return 
    endif
